                ...
                <div class="wrap clearFix">
                    ...
                    <div class="col1-4">
                        ...
                        <form action="" method="post">
                            <fieldset><input type="text" class="text" onclick="this.value = ''" onblur="if (!this.value) this.value = 'Your E-mail'" value="Your E-mail"><input type="submit" class="submit" value="Subscribe"></fieldset></form>                                      
                    </div>
